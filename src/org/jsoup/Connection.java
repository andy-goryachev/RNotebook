...
public interface Connection
{
	...
	/**
	 * Set the request timeouts (connect and read). If a timeout occurs, an Exception will be thrown. The default
	 ...
	 * default this is <b>false</b>; an Exception is thrown if an error is encountered. If set to <b>true</b>, the
	 ...
	 * content-type will cause an Exception to be thrown. (This is to prevent producing garbage by attempting to parse
	...
	{
		/**
		 * Get the request connect timeout, in milliseconds.
		...
		/**
		 * Update the request connect timeout.
		 * @param millis timeout, in milliseconds
		 * @return this Request, for chaining
		 */
		public Request setConnectTimeout(int millis);
		
		
		/**
		 * Update the request read timeout.
		 * @param millis timeout, in milliseconds
		 * @return this Request, for chaining
		 */
		public Request setReadTimeout(int millis);
		 ...
		 * @return true if errors will be ignored; false (default) if HTTP errors will cause an Exception to be thrown.
		 */
		 ...
		 * @return true if invalid content-types will be ignored; false (default) if they will cause an Exception to be thrown.
		 */
