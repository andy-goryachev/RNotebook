...
public abstract class RPrintUtilities {
	...
	protected static int xOffset;					// The x-offset (for the page margin) when printing.
	protected static int tabSizeInSpaces;			// The length of a tab, in spaces.
	protected static FontMetrics fm;				// The metrics of the font currently being used to print.
