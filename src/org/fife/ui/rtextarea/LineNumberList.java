...
public class LineNumberList extends AbstractGutterComponent
	...
	protected int currentLine;	// The last line the caret was on.
	protected int lastY = -1;		// Used to check if caret changes lines when line wrap is enabled.
...
*/
	 ...
	 */
	protected class Listener implements CaretListener, PropertyChangeListener {
