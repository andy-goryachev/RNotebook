...
public class Gutter extends JPanel {
	 ...
	 */
	protected void clearActiveLineRange() {
	 ...
	 */
	protected void setActiveLineRange(int startLine, int endLine) {
...
public void setBorder(Border border) {
	 ...
	 * resized.
	 */
	protected class TextAreaListener extends ComponentAdapter
