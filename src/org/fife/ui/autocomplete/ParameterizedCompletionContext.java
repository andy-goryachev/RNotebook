...
class ParameterizedCompletionContext {
	 ...
	 */
	protected ParameterizedCompletion pc;
	 ...
	 */
	protected Highlighter.HighlightPainter p;

	protected Highlighter.HighlightPainter endingP;

	protected Highlighter.HighlightPainter paramCopyP;
	...
	protected List<ParamCopyInfo> paramCopyInfos;

	protected transient boolean ignoringDocumentEvents;
	 ...
	 * before this tool tip disappears.
	 */
	protected Position maxPos; // Moves with text inserted.

	protected Position defaultEndOffs;
	 ...
	 */
	protected ParameterizedCompletionChoicesWindow paramChoicesWindow;
    ...
    protected void moveToNextParam() {
	 ...
	 * @see #moveToNextParam()
	 */
	protected void moveToPreviousParam() {
	...
	protected void possiblyUpdateParamCopies(Document doc) {
	 ...
	 */
	protected void prepareParamChoicesWindow() {
	 ...
	 */
	protected void removeParameterHighlights() {
		JTextComponent tc = ac.getTextComponent();
	 ...
	 */
	protected String updateToolTipText() {
	 ...
	 */
	protected class GotoEndAction extends AbstractAction {
	 ...
	 */
	protected class ClosingAction extends AbstractAction {
	 ...
	 * is visible.
	 */
	protected class Listener implements FocusListener, CaretListener,
							DocumentListener {
	 ...
	 */
	protected class NextParamAction extends AbstractAction {
	...
	protected static class ParamCopyInfo {
	 ...
	 */
	protected class PrevParamAction extends AbstractAction {
