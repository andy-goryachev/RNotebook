...
public class AutoCompletion {
	 ...
	 */
	protected Action oldTriggerAction;
	 ...
	 * popup windows.
	 */
	protected ParentWindowListener parentWindowListener;
	 ...
	 */
	protected class LookAndFeelChangeListener implements PropertyChangeListener {
	 ...
	 */
	protected class ParentWindowListener extends ComponentAdapter implements
			WindowFocusListener {
	 ...
	 * Listens for events from the popup window.
	 */
	protected class PopupWindowListener extends ComponentAdapter {
	 ...
	 */
	protected class TextComponentListener extends FocusAdapter implements
			HierarchyListener {
