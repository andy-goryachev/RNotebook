...
public class ClassFileWriter
{
	 ...
	 */
	protected static char arrayTypeToName(int type)
	{
		switch(type)
		{
	 ...
	 */
	protected static String descriptorToInternalName(String descriptor)
	{
	 ...
	 */
	protected int[] createInitialLocals()
	{
	...
	/*
	    ...
	    perverted.
	*/
	protected static int sizeOfParameters(String pString)
	{
	...
	*/
	...
	protected int[] itsSuperBlockStarts;
	protected int itsSuperBlockStartsTop;
	...
	protected UintMap itsJumpFroms;
	...
	protected ExceptionTableEntry itsExceptionTable[];
	protected int itsExceptionTableTop;

	private int itsLineNumberTable[]; // pack start_pc & line_number together
	private int itsLineNumberTableTop;

	protected byte[] itsCodeBuffer = new byte[256];
	protected int itsCodeBufferTop;

	protected ConstantPool itsConstantPool;

	private ClassFileMethod itsCurrentMethod;
	private short itsStackTop;

	protected short itsMaxStack;
	protected short itsMaxLocals;
	...
	protected short itsThisClassIndex;
...
final class ConstantPool
{
	...
	static final byte CONSTANT_Class = 7, CONSTANT_Fieldref = 9, CONSTANT_Methodref = 10, CONSTANT_InterfaceMethodref = 11, CONSTANT_String = 8, CONSTANT_Integer = 3, CONSTANT_Float = 4, CONSTANT_Long = 5, CONSTANT_Double = 6, CONSTANT_NameAndType = 12, CONSTANT_Utf8 = 1;
