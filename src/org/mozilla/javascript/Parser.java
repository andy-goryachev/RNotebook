...
public class Parser
{
	...
	Scope currentScope;
	protected int endFlags;
	protected boolean inForInit; // bound temporarily during forStatement()
	protected Map<String,LabeledStatement> labelSet;
	protected List<Loop> loopSet;
	protected List<Jump> loopAndSwitchSet;
	...
	// Exception to unwind
	protected static class ParserException
	...
	protected static class ConditionData
	{
		AstNode condition;
		int lp = -1;
		int rp = -1;
