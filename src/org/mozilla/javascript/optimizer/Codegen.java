    ...
    implements Evaluator
{
	...
	private void emitDirectConstructor(ClassFileWriter cfw, OptFunctionNode ofn)
	{
		...
		*/
		cfw.startMethod(getDirectCtorName(ofn.fnode), getBodyMethodSignature(ofn.fnode), (short)(ACC_STATIC | ACC_PRIVATE));
	...
	{
		cfw.startMethod("exec", "(Lorg/mozilla/javascript/Context;" + "Lorg/mozilla/javascript/Scriptable;" + ")Ljava/lang/Object;", (short)(ACC_PUBLIC | ACC_FINAL));
...
class BodyCodegen
{
	...
	private void generateArrayLiteralFactory(Node node, int count)
	{
		...
		argsLocal = firstFreeLocal++;
		localsMax = firstFreeLocal;
		cfw.startMethod(methodName, "(Lorg/mozilla/javascript/Context;" + "Lorg/mozilla/javascript/Scriptable;" + "Lorg/mozilla/javascript/Scriptable;" + "[Ljava/lang/Object;" + ")Lorg/mozilla/javascript/Scriptable;", ACC_PRIVATE);
	...
	private void visitSpecialCall(Node node, int type, int specialType, Node child)
	{
		...
		if(type == Token.NEW)
		{
			...
			callSignature = "(Lorg/mozilla/javascript/Context;" + "Ljava/lang/Object;" + "[Ljava/lang/Object;" + "Lorg/mozilla/javascript/Scriptable;" + "Lorg/mozilla/javascript/Scriptable;" + "I" // call type
			    + ")Ljava/lang/Object;";
			cfw.addALoad(variableObjectLocal);
			cfw.addALoad(thisObjLocal);
		...
		else
		{
			...
			callSignature = "(Lorg/mozilla/javascript/Context;" + "Lorg/mozilla/javascript/Callable;" + "Lorg/mozilla/javascript/Scriptable;" + "[Ljava/lang/Object;" + "Lorg/mozilla/javascript/Scriptable;" + "Lorg/mozilla/javascript/Scriptable;" + "I" // call type
	...
	protected String exceptionTypeToName(int exceptionType)
	{
	...
	private class ExceptionManager
	{
		...
		private void endCatch(ExceptionInfo ei, int exceptionType, int catchEnd)
		{
			...
			{
				cfw.addExceptionHandler(ei.exceptionStarts[exceptionType], catchEnd, ei.handlerLabels[exceptionType], exceptionTypeToName(exceptionType));
			}
		}
	...
	protected Node getFinallyAtTarget(Node node)
	{
		if(node == null)
		{
			return null;
