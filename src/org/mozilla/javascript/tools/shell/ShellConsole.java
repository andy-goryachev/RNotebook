...
{
	protected final static Class[] NO_ARG = {};
	protected final static Class[] BOOLEAN_ARG = { Boolean.TYPE };
	protected final static Class[] STRING_ARG = { String.class };
	protected final static Class[] CHARSEQ_ARG = { CharSequence.class };
	...
	protected static Object tryInvoke(Object obj, String method, Class[] paramTypes, Object... args)
	{
		try
		{
