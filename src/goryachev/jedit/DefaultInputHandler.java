    ...
    extends InputHandler
{
	...
	public void keyPressed(KeyEvent ev)
	{
		...
		if((modifiers & ~KeyEvent.SHIFT_MASK) != 0 || ev.isActionKey() || keyCode == KeyEvent.VK_BACK_SPACE || keyCode == KeyEvent.VK_DELETE || keyCode == KeyEvent.VK_ENTER || keyCode == KeyEvent.VK_TAB || keyCode == KeyEvent.VK_ESCAPE)
		{
			if(grabAction != null)
			{
				handleGrabAction(ev);
			...
			else if(o instanceof ActionListener)
			{
				...
				executeAction(((ActionListener)o), ev.getSource(), null);
	...
	public static KeyStroke parseKeyStroke(String keyStroke)
	{
		...
		{
			Log.print("Invalid key stroke: " + keyStroke);
			return null;
		}
		else
		{
