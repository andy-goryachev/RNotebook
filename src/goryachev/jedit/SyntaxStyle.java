...
public class SyntaxStyle
{
	 ...
	 */
	public Font getStyledFont(Font f)
	{
		if(f == null)
		{
		...
		lastFont = f;
		lastStyledFont = new Font(f.getFamily(), (bold ? Font.BOLD : 0) | (italic ? Font.ITALIC : 0), f.getSize());
		return lastStyledFont;
	}
	 ...
	 */
	public void setGraphicsFlags(Graphics g, Font f)
	{
		Font _font = getStyledFont(f);
		g.setFont(_font);
		g.setColor(color);
	}
